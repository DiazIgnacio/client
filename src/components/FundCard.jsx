      ...
      <div className='flex flex-col p-4'>
        ...
        >
          <div className='flex flex-col'>
            ...
            <p
              className='mt-[3px] font-epilogue font-normal
             text-[12px] leading-[18px] text-[#808191] sm:max-w-[120px]
             truncate'
            >
              Raised of {target}
            </p>
        ...
        <div className='flex items-center mt-[20px] gap-[12px]'>
          ...
          <p
            className='flex-1 font-epilogue font-normal
           text-[12px] text-[#808191] truncate'
          >
