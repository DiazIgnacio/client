...
const CampaignDetails = () => {
  ...
  return (
    <div>
      ...
      <div
        className='mt-[60px] flex lg:flex-row
       flex-col gap-5'
      >
        ...
        text-white uppercase'
          ...
          <div className='mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]'>
            <p
              className='font-epilogue font-medium text-[20px]
            ...
            <div className='mt-[30px]'>
              ...
              />
              <div
                className='my-[20px] p-4 bg-[#13131a]
               rounded-[10px]'
              >
                <h4
                  className='font-epilogue font-semibold text-[14px]
                ...
                <p
                  className='mt-[20px] font-epilogue font-normal
